...
pranks = [['Покупка спермы', '421105263', '-160306783_456239324'], ['Порнография на компе', '1073594097', '-190624614_456239021'], ['Вы - киберпреступник', '182647907', '-160306783_456239247'], ['Таксист ждет', '2107547006', '-160306783_456239273'], ['Вы - шпион Пентагона', '1201123265', '509525536_456239070'], ['Паскуда бл', '1021616219', '-160306783_456239243']]
            ...
            if not isWhiteListed(message[3]):
                ...
                for i in range(0, 6):
                    if msg == pranks[i][0]:
                        ...
                        sendMessage(message[3], 'Установлен пранк: ' + pranks[i][0] + '\nВведите номер телефона:', keyboard_main, 'audio' + pranks[i][2])
                        break
                if prank:
                    break
                if msg == 'Пранки':
